...
### 💻 Tech Stack 
![Skills](https://skills.syvixor.com/api/icons?perline=15&i=reactjs,typescript,zod,tailwindcss,motion,swiper,vite,vitest,nodejs,expressjs,mongodb,postman,javascript,html,css3,python,sql,markdown,npm,pnpm,git,github,githubcopilot,githubactions,terraform,amazonwebservices,vercel,netlify,render,cisco)

### ✍️ Latest Tech Blog Posts with 10K+ Total Views
